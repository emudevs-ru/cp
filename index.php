        ...
        <div class="container">
            <div class="error-container">
                <div class="error-info">
                    <h1>В разработке</h1>
                    <p>В данный момент ведётся активная разработка приложения.<br>Пожалуйста, зайдите позже.<br>Мы также объявим об окончании разработки на <a href="https://emudevs.ru/">нашем форуме</a></p>
                </div>
